...
export class FooterComponent {
  socialLinks: SocialLink[] = [
    {
      name: 'GitHub',
      iconDesktop: 'RRSS=Github, Dispositivo=Desktop.png',
      iconMobile: 'RRSS=Github, Dispositivo=Mobile.png',
      url: 'https://github.com/santiscally?tab=repositories'
    },
    {
      name: 'Email',
      iconDesktop: 'RRSS=Email, Dispositivo=Desktop.png',
      iconMobile: 'RRSS=Email, Dispositivo=Mobile.png',
      url: 'mailto:santiscally@gmail.com?subject=Consulta%20Simple%20Apps&body=Hola,%20me%20gustaría%20obtener%20más%20información%20sobre%20sus%20servicios.'
    },
    {
      name: 'Whatsapp',
